...
router.post('/', authenticate, validateBody(schemas.schemaAdd), ctrl.addContact);

router.put('/:contactId', authenticate, isValidId, validateBody(schemas.schemaUpd), ctrl.updateContact);
